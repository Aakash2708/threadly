...
export const GET_USERS_TWEET_REQUEST= "GET_USERS_TWEETS_REQUEST";
export const GET_USERS_TWEET_SUCCESS= "GET_USERS_TWEETS_SUCCESS";
export const GET_USERS_TWEET_FAILURE= "GET_USERS_TWEETS_FAILURE";
...
export const LIKE_TWEET_REQUEST= "LIKE_TWEETS_REQUEST";
export const LIKE_TWEET_SUCCESS= "LIKE_TWEETS_SUCCESS";
export const LIKE_TWEET_FAILURE= "LIKE_TWEETS_FAILURE";
